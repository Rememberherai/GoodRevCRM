          ...
          <div className="rounded-md border p-3 space-y-2">
            {isGrants ? (
              ...
              <>
                ...
                <ToolGroup name="Events" tools={['list', 'get', 'create', 'update', 'delete', 'publish', 'list_registrations', 'check_in', 'cancel_registration', 'create_ticket_type', 'list_series', 'create_series', 'update_series', 'match_attendance', 'confirm_attendance']} />
                <ToolGroup name="Bug Reports" tools={['list', 'update_status']} />
              </>
            ) : (
              <>
