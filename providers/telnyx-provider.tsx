          ...
          if (notification.type === 'callUpdate' && notification.call) {
            ...
            switch (state) {
              ...
              case 'answering':
                setCallState('active');
                startTimer();
                // Note: Recording for WebRTC calls is handled by the Outbound Voice Profile
                // in the Telnyx portal, not via the record_start API (which requires a
                // call_control_id that WebRTC SDK calls don't expose).
                break;
              case 'held':
