...
import { getServiceType, updateServiceType, deleteServiceType } from '@/lib/service-types/service';
...
export async function GET(_request: Request, context: RouteContext) {
  try {
    ...
    const serviceType = await getServiceType({ supabase, projectId: project.id }, id);
...
export async function DELETE(_request: Request, context: RouteContext) {
  try {
    ...
    await deleteServiceType({ supabase, projectId: project.id }, id);
