  ...
  },
  {
    ...
    definition: {
      ...
      nodes: [
        ...
        { id: 'switch-1', type: 'switch', position: { x: 250, y: 120 }, data: { label: 'Which Stage?', config: { field: 'to_stage', cases: [{ value: 'won', label: 'Won' }, { value: 'lost', label: 'Lost' }, { value: 'negotiation', label: 'Negotiation' }], defaultLabel: 'Other' } } },
      ...
      edges: [
        ...
        { id: 'e2', source: 'switch-1', target: 'action-won', sourceHandle: 'case-won', label: 'Won' },
        { id: 'e3', source: 'switch-1', target: 'action-lost', sourceHandle: 'case-lost', label: 'Lost' },
        { id: 'e4', source: 'switch-1', target: 'action-nego', sourceHandle: 'case-negotiation', label: 'Negotiation' },
        { id: 'e5', source: 'switch-1', target: 'end-2', sourceHandle: 'default', label: 'Other' },
  ...
  },
  {
    ...
    definition: {
      ...
      nodes: [
        ...
        { id: 'delay-1', type: 'delay', position: { x: 250, y: 240 }, data: { label: 'Wait 2 Days', config: { duration_ms: 172800000 } } },
        ...
        { id: 'delay-2', type: 'delay', position: { x: 250, y: 480 }, data: { label: 'Wait 5 Days', config: { duration_ms: 432000000 } } },
