...
interface RouteContext {
  params: Promise<{ slug: string; oppId: string; quoteId: string; itemId: string }>;
}

export async function PATCH(request: Request, context: RouteContext) {
  try {
    const { slug, oppId, quoteId, itemId } = await context.params;
