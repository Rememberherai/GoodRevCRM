...
export default function TimeLogSubtabPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setItems(all.filter((c) => ['volunteer_hours', 'service'].includes(c.type)));
    } catch (loadError) {
    ...
    <>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Work hours and service delivery records.</CardDescription>
        </CardHeader>
      ...
      <TimeLogEntry open={open} onOpenChange={setOpen} onCreated={() => void load()} />
    </>
  );
}
