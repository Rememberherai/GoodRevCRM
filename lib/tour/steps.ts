...
const communitySteps: TourStepDef[] = [
  ...
  { tourId: '/programs', title: 'Programs', content: 'Manage community programs — enrollment, attendance, and waivers.' },
  ...
  { tourId: '/referrals', title: 'Referrals', content: 'Track referrals between organizations and services.' },
  { tourId: '/contractors', title: 'Contractors', content: 'Manage contractor profiles, certifications, and assignments.' },
  { tourId: '/employees', title: 'Employees', content: 'Track employees with time clock kiosk and PIN-based check-in.' },
  { tourId: '/jobs', title: 'Jobs', content: 'Assign and track contractor work — scopes, timelines, and completion.' },
  { tourId: '/timesheets', title: 'Timesheets', content: 'Review and approve employee and contractor timesheets.' },
