...
const REPORTABLE_OBJECTS: Record<string, ReportableObject> = {
  organizations: {
    ...
    fields: [
      ...
      { name: 'city', label: 'City', type: 'text', aggregatable: false, groupable: true, filterable: true },
      { name: 'state', label: 'State', type: 'text', aggregatable: false, groupable: true, filterable: true },
      { name: 'country', label: 'Country', type: 'text', aggregatable: false, groupable: true, filterable: true },
    ...
    relations: [
      { name: 'people', label: 'People', targetObject: 'people', type: 'has_many', foreignKey: 'organization_id', targetKey: 'id' },
  ...
  sent_emails: {
    ...
    fields: [
      ...
      { name: 'organization_id', label: 'Organization ID', type: 'uuid', aggregatable: false, groupable: true, filterable: true },
      { name: 'opportunity_id', label: 'Opportunity ID', type: 'uuid', aggregatable: false, groupable: true, filterable: true },
      { name: 'sent_by', label: 'Sent By', type: 'uuid', aggregatable: false, groupable: true, filterable: true },
      { name: 'created_at', label: 'Created At', type: 'datetime', aggregatable: false, groupable: true, filterable: true },
    ],
    relations: [
      { name: 'organization', label: 'Organization', targetObject: 'organizations', type: 'belongs_to', foreignKey: 'organization_id', targetKey: 'id' },
  ...
  sequence_enrollments: {
    ...
    fields: [
      ...
      { name: 'started_at', label: 'Started At', type: 'datetime', aggregatable: false, groupable: true, filterable: true },
      { name: 'completed_at', label: 'Completed At', type: 'datetime', aggregatable: false, groupable: true, filterable: true },
      { name: 'created_at', label: 'Created At', type: 'datetime', aggregatable: false, groupable: true, filterable: true },
    ],
    relations: [
